...
def load_feedback(fmt="UIR", reader: Reader = None) -> List:
    ...
    """
    fpath = 'experiment/seer-ijcai2020/camera/ratings.txt'
...
def load_review(reader: Reader = None) -> List:
    ...
    """
    fpath = 'experiment/seer-ijcai2020/camera/review.txt'
    reader = Reader() if reader is None else reader
...
def load_sentiment(reader: Reader = None) -> List:
    ...
    """
    fpath = 'experiment/seer-ijcai2020/camera/sentiment.txt'
    reader = Reader() if reader is None else reader
